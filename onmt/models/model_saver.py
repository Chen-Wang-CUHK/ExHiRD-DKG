...
class ModelSaver(ModelSaverBase):
    ...
    def _save(self, step, stats=None):
        ...
        if stats is None:
            ...
            checkpoint_path = '{}_ppl_{:.3f}_acc_{:.3f}_step_{}.pt'.format(self.base_path,
                                                                           stats.ppl(),
                                                                           stats.accuracy(),
                                                                           step)
        logger.info("Saving checkpoint " + checkpoint_path)
        # checkpoint_path = '%s_ppl_{:.2f}_acc_{:.2f}_step_%d.pt' % (self.base_path, stats.accuracy(), stats.ppl(), step)
