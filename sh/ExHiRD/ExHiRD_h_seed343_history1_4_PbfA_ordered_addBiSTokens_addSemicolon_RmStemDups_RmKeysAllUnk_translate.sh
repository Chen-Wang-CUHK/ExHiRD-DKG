#!/bin/bash
#SBATCH --job-name=ExHiRD_h_seed343_history1_4_PbfA_ordered_addBiSTokens_addSemicolon_RmStemDups_RmKeysAllUnk_translate
#SBATCH --mail-user=wangzaicuhk@gmail.com
#SBATCH --mail-type=ALL
#SBATCH --output=/research/king3/wchen/Code4Git/ExHiRD-DKG/sh/ExHiRD/sh_log/ExHiRD_h_seed343_history1_4_PbfA_ordered_addBiSTokens_addSemicolon_RmStemDups_RmKeysAllUnk_translate.out
#SBATCH --gres=gpu:1
#SBATCH -p gpu_24h
#SBATCH -w gpu24
...
SAVED_MODEL="${model_name}_seed${seed}_${processed_type}_ppl_4.977_acc_64.375_step_137500.pt"
